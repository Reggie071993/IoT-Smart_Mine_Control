...
<head>
    ...
    <title>Mine Manager - Dashboard</title>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-right" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="add_expense.php" class="list-group-item list-group-item-action sidebar-active"><span data-feather="plus-square"></span> Add Sensor</a>
                <a href="manage_expense.php" class="list-group-item list-group-item-action"><span data-feather="plus-square"></span> Manage Sensor</a>
            </div>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container">
                <h3 class="mt-4 text-center">Add Sensor</h3>
                <hr>
                <div class="row ">
                    ...
                    <div class="col-md" style="margin:0 auto;">
                        <form action="" method="POST">
                            <div class="form-group row">
                                <label for="expenseamount" class="col-sm-6 col-form-label"><b>Results</b></label>
                                <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="expensecategory" id="expensecategory4" value="Temperature sensor" <?php echo ($expensecategory == 'Temperature') ? 'checked' : '' ?>>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="expensecategory" id="expensecategory3" value="dust sensor" <?php echo ($expensecategory == 'dust sensor') ? 'checked' : '' ?>>
                                            <label class="form-check-label" for="expensecategory3">
                                                dust sensor
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="expensecategory" id="expensecategory2" value="Breath sensor" <?php echo ($expensecategory == 'Breath rate sensor') ? 'checked' : '' ?>>
                                            <label class="form-check-label" for="expensecategory2">
                                                Breath sensor
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="expensecategory" id="expensecategory1" value="Vibration sensor" <?php echo ($expensecategory == 'Vibration sensor') ? 'checked' : '' ?>>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12 text-right">
                                    ...
                                    <?php else : ?>
                                        <button type="submit" name="add" class="btn btn-lg btn-block btn-success" style="border-radius: 0%;">Add sensor</button>
                                    <?php endif ?>
                                </div>
                            </div>
                        </form>
