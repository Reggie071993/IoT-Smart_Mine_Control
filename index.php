  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="add_expense.php" class="list-group-item list-group-item-action "><span data-feather="plus-square"></span> Add Sensor</a>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col text-center">
                    <a href="add_expense.php"><img src="icon/zeroo.png" width="57px" />
                      <p>Add Sensor</p>
                    </a>
                  </div>
                  <div class="col text-center">
                    <a href="manage_expense.php"><img src="icon/zero.png" width="57px" />
                      <p>Alarm</p>
                    </a>
                  </div>
                  <div class="col text-center">
          ...
          <div class="col-md">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title text-center">Sensor Category</h5>
              </div>
              <div class="card-body">
